...
function Login() {
  ...
  return (
    <div className={`flex py-8 items-center justify-center ${bgStyle} w-full h-screen`}>
        <div className={` mx-auto w-full max-w-lg bg-opacity-50 bg-gray-900 rounded-xl p-10 border border-black/10`} >
        <div className="mb-2 flex justify-center">
                    <span className="inline-block w-full max-w-[100px]">
                        <Logo width="100%" />
                    </span>
                 </div>
        <h2 className="text-center text-cyan-200 text-2xl font-bold leading-tight"> Log in to your account </h2>
